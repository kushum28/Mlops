...
getModelDetails(){
  ...
  modelHeaderCommand="az ml model list --model-name $modelName --resource-group $resourceGroupName --workspace-name $workspaceName $properties --latest --query '[0]' -o json"
